...
#define MEDIUM 25
#define HARD   20
#define SQUARE 49	/*SQUARE is the size of the board.*/
#define SHIPS  40	/*Number of ships allowed on board.*/
#define LARGE  2	/*Size of the largest ship on the board.*/
...
int prn_intro(int level)
{
	...
	printf("-  so try to imagein that the entire time. It'll be fun! -\n");
